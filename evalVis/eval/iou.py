...
def intersect(box_a, box_b):
   ...
   torch   box_b: (tensor) bounding boxes, Shape: [B,4].
    Return:
...
if __name__ == '__main__':
    box_a = torch.FloatTensor([[1,2,3,4],[2,3,4,5],[3,4,5,6]])
    box_b = torch.FloatTensor([[1,2,2,4],[2,3,4,5]])
 
    print(box_a[jaccard(box_a,box_b).max(0).indices])