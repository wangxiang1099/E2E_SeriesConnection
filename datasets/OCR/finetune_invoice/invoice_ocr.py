...
class End2EndWithLoadInvoiceDataset(InvoiceDataset):
    ...
    def __getitem__(self,idx):
        ...
        s2_targets = {}
        s2_targets["texts"] = texts

        s3_targets = {}
        s3_targets["kinds"] = kinds
        
        return name, image, targets, s2_targets, s3_targets


if __name__ == '__main__':

    dataset = End2EndWithLoadInvoiceDataset(root='/home/wx/data/iocr_training/invoices', mode=MIX)
    print(dataset[0])    
